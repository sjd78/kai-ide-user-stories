...
## Simple catalog
  ...
  - Quick pick menu for analysis configuration profiles
    - Pick one of the profiles
    - Open the profile manager

  - Quick pick menu for managing the Kai server
    - Open the _guided setup of Kai runtime_
    - Verify the Kai runtime with feedback as a Notification
    - Restart the server

  - Quick pick menu for an active file
  ...
  - Global status bar item (for the Workspace) -- for extension/analysis
  ...
  - Global status bar item (for the Workspace) -- for Kai resolution
    - Kai is ready
    - Kai is working on a resolution
    - Resolutions are ready for review

  - Context status bar item (for the Editor)
  ...
  - Code editor (for viewing issues and incidents)
    - diagnostics
  ...
  - Issue view (webview in the editor location)
